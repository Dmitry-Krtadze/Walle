...
{
  size_t bytesRead = 0;
  // Используем новую функцию i2s_read вместо i2s_read_bytes
  i2s_read(I2S_NUM_0, (void *)data, numData, &bytesRead, portMAX_DELAY);
  return bytesRead;
}
...
void I2S_Write(char *data, int numData)
{
  ...
  // Используем новую функцию i2s_write вместо i2s_write_bytes
  i2s_write(I2S_NUM_0, (const void *)data, numData, &bytesWritten, portMAX_DELAY);
}